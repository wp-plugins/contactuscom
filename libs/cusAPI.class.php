...
class cUsComAPI_CF {
    ...
    public function getFormKeysData($cUs_API_Account, $cUs_API_Key, $cUs_Form_Type = 'contact_us'){
   ...
   public function get_deeplink($forms) {
    ...
    public function resetData(){
        ...
        cUsCF_inline_shortcode_cleaner();
