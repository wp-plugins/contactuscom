...
cUsCF_myjq(document).ready(function($) {
    ...
    try{
        ...
        cUsCF_myjq( "#cUsCF_exampletabs" ).tabs({active: false});
    ...
    cUsCF_myjq('.cUsCF_LoginUser').click(function(){//LOGIN ALREADY USERS
        ...
        if(!email.length){
            ...
            if(!bValid){
                ...
                cUsCF_myjq('.cUsCF_LoginUser').val('Loading . . .').attr({disabled:'disabled'});
                
                cUsCF_myjq.ajax({ type: "POST", url: ajax_object.ajax_url, data: {action:'cUsCF_loginAlreadyUser',email:email,pass:pass},
                    success: function(data) {
                        ...
                        switch(data){
                            ...
                            case '2':
                                ...
                                cUsCF_myjq('.cUsCF_LoginUser').val('Login').removeAttr('disabled');
        ...
        cUsCF_myjq('#cUsCF_CreateCustomer').click(function() {
           ...
           if( !cUsCF_first_name.length){
               ...
               cUsCF_myjq('.loadingMessage').fadeOut();
                ...
                cUsCF_myjq('#cUsCF_CreateCustomer').val('Loading . . .').attr({disabled:'disabled'});
                
                postData = {action: 'cUsCF_verifyCustomerEmail', fName:str_clean(cUsCF_first_name),lName:str_clean(cUsCF_last_name),Email:cUsCF_email,website:cUsCF_web};
                    ...
                    success: function(data) {
                        switch(data){
                            ...
                            case '2':
                                ...
                                cUsCF_myjq('#cUsCF_CreateCustomer').val('Continue to Step 2').removeAttr('disabled'); 
                                setTimeout(function(){
    ...
    try{ cUsCF_myjq('#cUsCF_SendTemplates').click(function() {
           ...
           if(!Template_Desktop_Form.length){
               ...
               cUsCF_myjq( ".signup_templates" ).accordion({ active: 1 });
                ...
                cUsCF_myjq('#cUsCF_SendTemplates').val('Loading . . .').attr({disabled:'disabled'});
                    ...
                    success: function(data) {
                        ...
                        switch(data){
                            case '1':
                             ...
                             case '2':
                                message = 'Seems like you already have one Contactus.com Account, Please Login below!';
                                cUsCF_myjq('#cUsCF_SendTemplates').val('Build my account').removeAttr('disabled'); 
                                setTimeout(function(){
                                    cUsCF_myjq('#login_email').val(cUsCF_email).focus();
                                    cUsCF_myjq('#cUsCF_userdata').fadeOut();
                                    cUsCF_myjq('#cUsCF_settings').slideDown('slow');
    ...
    try{ cUsCF_myjq('#cUsCF_UpdateTemplates').click(function() {
           ...
           if(!Template_Desktop_Form.length){
               ...
               cUsCF_myjq( "#form_examples" ).accordion({ active: 1 });
                ...
                cUsCF_myjq('#cUsCF_UpdateTemplates').val('Loading . . .').attr({disabled:'disabled'});
                ...
                cUsCF_myjq.ajax({ type: "POST", url: ajax_object.ajax_url, data: {action:'cUsCF_UpdateTemplates',Template_Desktop_Form:Template_Desktop_Form,Template_Desktop_Tab:Template_Desktop_Tab},
                    success: function(data) {
                        ...
                        switch(data){
                            ...
                            default:
                                message = '<p>Ouch! unfortunately there has being an error during the application: <b>' + data + '</b>. Please try again!</a></p>';
                                cUsCF_myjq('#cUsCF_UpdateTemplates').val('Update my template').removeAttr('disabled'); 
                                break;
                        }
