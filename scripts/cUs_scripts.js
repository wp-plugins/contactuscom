...
jQuery(document).ready(function($) {
    ...
    allFields_reg = $( [] ).add(fname).add(lname).add(remail).add(website).add(pass1).add(pass2),
    tips = $( ".validateTips" );
    ...
    $('#cUs_registform').submit(function(){
        ...
        bValid = bValid && checkLength( website, "website", 2, 255 );
        if($( "#website1" ).val() == 'http://localhost'){
