                                            ...
                                            <div class="col-sm-12">
                                                <div class="white-menu">
                                                    ...
                                                    <ul class="nav nav-pills">
                                                        <li class="active"><a href="<?php echo cUsCF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim(cUsCF_PARTNER_URL . '/'.$partnerID . '/en/forms/gt/'.$oForm->form_id.'/formSettings/generalSettings')); ?>" target="_blank" title="Opens ContactUs admin panel in new window." class="tooltips">General Settings</a></li>
                                                        <li class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu" title="Opens ContactUs admin panel in new window." class="tooltips">
                                                                <li><a href="<?php echo cUsCF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim($default_deep_link)); ?>%26expand=4" target="_blank" title="Opens ContactUs admin panel in new window" class="tooltips" data-placement="right">Edit Form Design</a></li>
                                                                <li class="divider"></li>
                                                                <li><a href="<?php echo cUsCF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim($default_deep_link)); ?>%26expand=5" target="_blank" title="Opens ContactUs admin panel in new window" class="tooltips" data-placement="right">Edit Tab Design</a></li>
                                                            </ul>
                                                        </li>
                                                        <?php if ($oForm->form_type == 'contact_us') { ?><li class="active"><a href="<?php echo cUsCF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim($default_deep_link)); ?>%26expand=14%26newTemplate=genericTemplate1" target="_blank" title="Opens ContactUs admin panel in new window" class="tooltips">Fields</a></li><?php } ?>
                                                        <li class="active"><a href="<?php echo cUsCF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsCF_PARTNER_URL . '/'.$partnerID . '/en/forms/gt/'.$oForm->form_id.'/formTriggers/'); ?>" target="_blank" title="Opens ContactUs admin panel in new window." class="tooltips">Form Triggers</a></li>
                                                        <li class="active"><a href="<?php echo cUsCF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(trim($default_deep_link)); ?>%26expand=103" target="_blank" title="Opens ContactUs admin panel in new window." class="tooltips">Software Integrations</a></li>
                                                        <li class="active"><a href="<?php echo cUsCF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsCF_PARTNER_URL . '/'.$partnerID . '/en/forms/gt/'.$oForm->form_id.'/formSubmissionSettings/formNotifications/'); ?>" target="_blank" title="Opens ContactUs admin panel in new window." class="tooltips">Notifications</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
