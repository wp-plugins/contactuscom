                ...
                <div id="menu">
                    <div id="menuWrapper">
                        <ul id="tabs" data-tabs="tabs">
                            ...
                            <li>
                                <a href="#tabs1" role="button" class="btn forms-color" data-toggle="tab">
                                    <span class="icon-suitcase white"></span><span class="hidden-sm hidden-xs"> Forms</span>
                                </a>
                            </li>
                            <li>
                                <a href="#tabs2" role="button" class="btn chat-color" data-toggle="tab">
                                    <span class="icon-layout white"></span><span class="hidden-sm hidden-xs"> Form/Page Selection</span>
                                </a>
                            </li>
                            <li>
                                <a href="http://help.contactus.com/hc/en-us/sections/200204997-Contact-Form-Plugin-for-Wordpress-Documentation" role="button" class="btn contacts-color" target="_blank">
                                    <span class="icon-book white"></span><span class="hidden-sm hidden-xs"> Documentation</span>
                                </a>
                            </li>

                            <li>
                                <a href="<?php echo cUsCF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsCF_PARTNER_URL .'/'. $partnerID.'/en/forms/'); ?>" role="button" class="btn btn-yellow tooltips" target="_blank" title="Opens ContactUs.com admin panel in new window" data-placement="right">
            ...
            <div class="col-xs-4 col-md-2 col-lg-3 noPadding">
                ...
                <div class="btn-group pull-right" id="userMenu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="logout" target="_blank"  href="h<?php echo cUsCF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsCF_PARTNER_URL .'/'. $partnerID.'/en/account/returningLeadAlert'); ?>"><span class="icon-attention"></span> Returning Lead Alert </a>
                        </li>
                        <li>
