...
Tested up to: 3.9.1
Donate link:
Tags: contact form, contact form builder, contact page, contact us, contact us form, contact us page, form builder, captcha, contactus, contactus.com, email, database, signup form, newsletter, form, customer acquisition
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html

Flexible and fast contact forms. We’re WordPress evangelists and have built tons of customization options to build a supercharged contact form.

== Description ==

**In less than five minutes** you can be up and running with your contact form on your WordPress website. Our contact forms are mobile optimized to increase conversions, focused on fighting spam, and we’ve got quick customization options for beginner admins and advanced features for code ninjas.Websites with more specific needs can use our online drag-and-drop form editor combined with our form designs designated as custom field templates to build a custom contact form, quote form, request form, feedback forms, or any other type of form you can think up!

When you use our contact form solution, you can also get alerts via SMS, email or direct the signups to 3rd party apps like MailChimp, Constant Contact, Google Docs, Zoho, SugarCRM, and many more. Starting with Version 3.5, you are also able to add Donation Forms, Appointment Forms, and Newsletter forms.

In short, we have the free tools to supercharge your contact form and make it easy to manage the submissions!
...
We have premium (paid) plans with advanced features, but our standared features are always free.

Remember we are [more than just contact forms](http://www.contactus.com/product-tour/). We offer a variety of free and premium customer acquisition tools.  For example, our live chat feature is a recent and highly effective tool to engage you visitors in real time.
...
Our Contact Form Plugin offers these options within the plugin:
...
Note: The asterisk (*) Signifies that this contact form feature can be further customized (outside of the plugin) from within your free [ContactUs.com account](http://www.contactus.com/login/)
