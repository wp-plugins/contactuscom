...
**In less than five minutes** you can be up and running with your contact form on your WordPress website. Our contact forms are mobile optimized to increase conversions, focused on fighting spam, and we’ve got quick customization options for beginner admins and advanced features for code ninjas. When you use our contact form solution, you can also get alerts via SMS, email or direct the signups to 3rd party apps like MailChimp, Constant Contact, Google Docs, Zoho, SugarCRM, and many more. Starting with Version 3.5, you are also able to add Donation Forms, Appointment Forms, and Newsletter forms. The Contact Form by ContactUs.com is better than ever!

In short, we'll supercharge your contact form and make it easy to manage the submissions!
...
Note: ContactUs.com has a simple html snippet that does not require a plugin, you can use both in WP templates as well as plain HTML. More infomation on this [here](http://help.contactus.com/hc/en-us/articles/200619888-Copy-Pasting-the-Code-vs-Implementing-through-the-WordPress-Plugin).
...
* Callout contact form Tab with choice of callout tab – text and color *
...
From within your free ContactUs.com account that is integrated with your contact form plugin, you’ll be able to further customize your form with advanced functionality:
...
* Create or upload a custom contact form tab (so you can use alternative text besides “Contact Us”)
