                                                    ...
                                                    */
                                                    ...
                                                    <?php
                                                        foreach ($aryCategoriesAndSub as $category => $arySubs) { ?>
                                                            ...
                                                            <li class="parent-category"><span id="<?php echo str_replace(' ', '-', $category); ?>" class="parent-title"><?php echo trim($category); ?></span>
                                                            <?php if(is_array($arySubs)) {?>
                                                            <ul class="sub-category">
                                                                <?php foreach ($arySubs as $Sub) { ?>
                                                                <li><span><?php echo trim($Sub); ?></span></li>
                                                                <?php } ?>
                                                            </ul>
                                                            <?php } ?>
                                                        </li>
                                                ...
                                                <div id="user-interests-box" class="questions-box">
                                                    ...
                                                    */  
                                                    ...
                                                    <?php foreach ($aryGoals as $Goal) { ?>
                                                        <li <?php if($Goal === 'Other') { ?>id="other"<?php } ?>><span  <?php if (strpos($Goal,'to my email') !== false) { ?> class="grey" <?php } ?>><?php echo trim($Goal); ?></span></li>
                                                    <?php } ?>
                                                    </ul>
                                                    <?php } ?>
