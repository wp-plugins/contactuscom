                                ...
                                <div class="left-content">
                                    ...
                                    <div class="versions_options">
                                        ...
                                        <div class="button_set">
                                            ...
                                            $createform = $default_deep_link.'?pageID=81&id=0&do=addnew&formType=contact_us';

                                            ?>
                                            <a href="https://admin.contactus.com/partners/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo urlencode($cUs_API_Key); ?>&confirmed=1&redir_url=<?php echo urlencode(trim($reports)); ?>" target="_blank" class="deep_link_action"  title="NOTE: You will be redirected to your ContactUs.com admin panel to edit your form configurations.">Detailed Reports</a>
                                            <a href="https://admin.contactus.com/partners/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo urlencode($cUs_API_Key); ?>&confirmed=1&redir_url=<?php echo urlencode(trim($upgrade)); ?>" target="_blank" class="deep_link_action"  title="NOTE: You will be redirected to your ContactUs.com admin panel to edit your form configurations.">Upgrade Account</a>
                                            <a href="https://admin.contactus.com/partners/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo urlencode($cUs_API_Key); ?>&confirmed=1&redir_url=<?php echo urlencode(trim($createform)); ?>" target="_blank" class="deep_link_action"  title="NOTE: You will be redirected to your ContactUs.com admin panel to edit your form configurations.">Create a New Form</a>
                                        </div>
                                                                                    ...
                                                                                    <div>
                                                                                        <div class="form_templates terminology_c Template_Contact_Form">
                                                                                            ...
                                                                                            <div class="button_set">
                                                                                                ...
                                                                                                ?>
                                                                                                <a href="https://admin.contactus.com/partners/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo urlencode($cUs_API_Key); ?>&confirmed=1&redir_url=<?php echo urlencode(trim($default_deep_link)); ?>%26expand=4" target="_blank" class="btn lightblue abutton"  title="NOTE: You will be redirected to your ContactUs.com admin panel to edit your form configurations.">Configure Form</a>
                                                                                                <a href="https://admin.contactus.com/partners/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo urlencode($cUs_API_Key); ?>&confirmed=1&redir_url=<?php echo urlencode(trim($default_deep_link)); ?>%26expand=5" target="_blank" class="btn lightblue abutton"  title="NOTE: You will be redirected to your ContactUs.com admin panel to edit your form configurations.">Configure Tab</a>
                                                                                                <a href="https://admin.contactus.com/partners/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo urlencode($cUs_API_Key); ?>&confirmed=1&redir_url=<?php echo urlencode(trim($ablink)); ?>" target="_blank" class="btn lightblue abutton"  title="NOTE: You will be redirected to your ContactUs.com admin panel to edit your form configurations.">A/B Test</a>                                                                                               
