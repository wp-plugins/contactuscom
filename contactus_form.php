            ...
            <div class="cUsCF_header">
                ...
                <?php if(!empty($cUs_API_Account)){ ?>
                    <div class="help_section">
                        <a class="setLabels ug" href="javascript:;" title="Show User Guide"><img src="<?php echo plugins_url('style/images/cu-help-m.png', __FILE__) ;  ?> " alt="Show User Guide"/></a>
                        <a class="setLabels chat" href="javascript:contactusOpenByFormKey('MWVhZjJlMTNiY2I,');" title="Any Questions? Chat Now!"><img src="<?php echo plugins_url('style/images/cu-chat-m.png', __FILE__) ;  ?> " alt="Any Questions? Chat Now!"/></a>
                    </div>
                <?php } ?>
                ...
                <div id="cUsCF_tabs">
                    <ul>
                        ...
                        */  
                        ...
                        <?php if ( strlen($form_key) && strlen($cUs_API_Account) ){ ?><li id="cUsCF_tab_fpt"><a href="#tabs-1">Form Placement</a></li><?php } ?>
                        <?php if ( strlen($form_key) && strlen($cUs_API_Account) ){ ?><li id="cUsCF_tab_fs"><a href="#tabs-2">Form Settings</a></li><?php } ?>
                        <?php if ( strlen($form_key) && strlen($cUs_API_Account) ){ ?><li id="cUsCF_tab_sc"><a href="#tabs-3">Shortcodes</a></li><?php } ?>
                        <?php if ( strlen($form_key) && strlen($cUs_API_Account) ){ ?><li id="cUsCF_tab_doc" class="gotohelp"><a href="http://help.contactus.com/hc/en-us/sections/200204997-Contact-Form-Plugin-by-ContactUs-com" target="_blank">Documentation</a></li><?php } ?>
                        <?php if ( strlen($form_key) && strlen($cUs_API_Account) ){ ?><li id="cUsCF_tab_ac"><a href="#tabs-4">Account</a></li><?php } ?>
                        <?php if ( strlen($form_key) && strlen($cUs_API_Account) ){ ?><li id="cUsCF_tab_cp" class="gotohelp"><a href="<?php echo cUsCF_PARTNER_URL; ?>/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo $cUs_API_Key; ?>&confirmed=1" target="_blank" rel="toDash" class="goToDashTab">Form Control Panel</a></li><?php } ?>
                    </ul>
                                        ...
                                        <div id="cats_selection">
                                            ...
                                            <form action="/" onsubmit="return false;">
                                                ...
                                                <div id="user-interests-box" class="questions-box">
                                                    <div class="cc-headline">Hi <?php echo $current_user->first_name; ?></div>
                            ...
                            <div class="right-content">
                                <?php if(!empty($cUs_API_Account)){ ?>
                                    <div class="upgrade_features">
                                        <a href="http://wordpress.org/support/view/plugin-reviews/contactuscom" target="_blank" alt="Click here to go to plugin forum" title="Click here to go to plugin forum">
                                            <span class="stars">&#9733;&#9733;&#9733;&#9733;&#9733;</span><br/>
                                            Help us by submitting a plugin review on WordPress.org <span class="un">here</span> &#x276f;
                                        </a>
                                    </div>
                    ...
                    <?php }else{
                        ...
                        if (strlen($cUs_API_Account)) {
                            ...
                            */
                            ...
                            //update_option('cUsCF_settings_intro_hints', 1);
                            ...
                            <div class="left-content">
                                ...
                                <div class="versions_options">
                                    ...
                                    <div class="button_set_tabs_fp">
                                        <button id="cUsCF_tab_button" class="form_version btn_tab tab_button setlabel_all <?php echo ( $cus_version == 'tab' )?'green':'gray'; ?>" value="tab_version" <?php echo ( $cus_version == 'tab' )?'disabled="disabled"':''; ?> title="Places Default Form on all pages">Place Across Your Site</button>
                                        <button id="cUsCF_custom" class="form_version btn_tab custom setLabel_Custom <?php echo ( $cus_version == 'selectable' )?'green':'gray'; ?>" value="select_version" <?php echo ( $cus_version == 'selectable' )?'disabled="disabled"':''; ?> title="Lets You Choose Different Forms for Each Page">Choose Pages</button>
                               ...
                               <form method="post" action="admin.php?page=cUs_form_plugin" id="cUsCF_selectable" class="cus_versionform tab_version <?php echo ( strlen($cus_version) && $cus_version != 'tab')?'hidden':''; ?>" name="cUsCF_defaultformkey">
                                   ...
                                   <div class="pageselect_cont">
                                       ...
                                       <ul class="selectable_pages defaultF cUsCF_sel_def">
                        ...
                        <div id="tabs-2">
                                ...
                                <div class="left-content">
                                    ...
                                    <div class="versions_options versions_options_fs">
                                        ...
                                        <!-- CONTACT FORMS-->
                                        <div class="gray_box">
                                            <h3 class="form_title"> <span id="cUsCF_ftype_cf">Contact Forms</span> <a id="cUsCF_new_cf" href="<?php echo cUsCF_PARTNER_URL; ?>/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo urlencode($cUs_API_Key); ?>&confirmed=1&redir_url=<?php echo urlencode(trim($createform)); ?>contact_us" target="_blank">Add a New Contact Form <span>+</span></a></h3>
                                                                ...
                                                                <div class="user_form_templates">
                                                                    ...
                                                                    foreach ($cUs_json->data as $oForms => $oForm) {
                                                                        ...
                                                                        if (cUsCF_allowedFormType($oForm->form_type) && $oForm->form_type == $form_Type) {
                                                                            ...
                                                                            <div class="form_templates_box" id="cUsCF_cf_box">
                                                                            ...
                                                                            <div class="form_description hidden" id="form_description_<?php echo $oForm->form_id; ?>">
                                                                                ...
                                                                                <div class="form_templates_tools">
                                                                                    <h4>Find instructions on how to build short codes and theme snippets <a href="javascript:;" class="blue_link" onclick="jQuery('#cUsCF_tabs').tabs({active: 2}); jQuery.colorbox.close();"> Here. </a></h4>
                                                                                    <h3>Form Tools</h3>
                                                                                    <div>
                                ...
                                <div>
                                    <div class="terminology_c">
                                        ...
                                        <ul class="hints">
                                            ...
                                            <li id="cUsCF_sc_wd"><b>Widget Tool</b><br/><p>Go to <a href="widgets.php"><b>Widgets here </b></a> and drag the ContactUs.com widget into one of your widget areas</p></li>
                                        </ul>
                        ...
                        <div id="tabs-4">
                            ...
                            <div class="left-content">
                                ...
                                <div class="button_set_tabs">
                                    ...
                                    ?>
                                    <a href="<?php echo cUsCF_PARTNER_URL; ?>/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo urlencode($cUs_API_Key); ?>&confirmed=1&redir_url=<?php echo urlencode(trim($reports)); ?>" target="_blank" class="deep_link_action_tab rep" id="cUsCF_CM">Contact Management</a>
                                    <a href="<?php echo cUsCF_PARTNER_URL; ?>/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo urlencode($cUs_API_Key); ?>&confirmed=1&redir_url=<?php echo urlencode(trim($acount)); ?>" target="_blank" class="deep_link_action_tab ac" id="cUsCF_AI">Account Information</a>
                                    <a href="<?php echo cUsCF_PARTNER_URL; ?>/index.php?loginName=<?php echo $cUs_API_Account; ?>&userPsswd=<?php echo urlencode($cUs_API_Key); ?>&confirmed=1&redir_url=<?php echo urlencode(trim($upgrade)); ?>" target="_blank" class="deep_link_action_tab ac" id="cUsCF_UA">Upgrade Account</a>
                                </div>
