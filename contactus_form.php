                            ...
                            <div class="left-content">
                                ...
                                <div class="versions_options">
                                    ...
                                    <div class="button_set_tabs_fp">
                                        <button class="form_version btn_tab tab_button setlabel_all <?php echo ( $cus_version == 'tab' )?'green':'gray'; ?>" value="tab_version" <?php echo ( $cus_version == 'tab' )?'disabled="disabled"':''; ?> title="Places Default Form on all pages">Place Across Your Site</button>
