...
if (!function_exists('cUsCF_admin_header')) {
    ...
    */
    function cUsCF_admin_header() {
        ...
        //INCLUDE CONTACTUS.COM DONATION FORM
        if ($current_screen->id == 'toplevel_page_cUs_form_plugin') {
            
            wp_register_script( 'donationform', '//cdn.contactus.com/cdn/forms/ZmE4YmY2ODJkNQ,,/contactus.js', false, '1.0', true );
            
            //wp_enqueue_script( 'donationform' );
        }
    }
